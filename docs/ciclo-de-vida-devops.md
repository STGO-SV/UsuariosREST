...
El flujo comienza en código y SQL versionables. Maven Wrapper compila y prueba con H2, por lo que el control de calidad no depende de AWS. Un `clean package` verde produce el JAR ejecutable que Docker inicia con `java -jar` y Tomcat embebido.
